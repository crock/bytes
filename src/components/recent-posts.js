                    ...
                    <h5 style={{fontSize: `1.35rem`, fontWeight: `bold`}}>Recent Posts</h5>
                    {
                        data.allWordpressPost.edges.map(post => (
                            <div className="rp-card" key={post.node.id} style={{
                                ...
                                <img className="author-profile-photo" src={post.node.author.avatar_urls.wordpress_48} alt="author avatar" style={{marginBottom: 0, marginRight: `15px`, borderRadius: `50%`, border: `3px solid #3ead5a`}} />
